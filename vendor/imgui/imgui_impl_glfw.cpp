...
void ImGui_ImplGlfw_ChangeMainWindow(void *ptr) { g_Window = static_cast<GLFWwindow *>(ptr); }
...
void ImGui_ImplGlfw_NewFrame() {
  ImGuiIO &io = ImGui::GetIO();
  IM_ASSERT(io.Fonts->IsBuilt() && "Font atlas not built! It is generally built by the renderer back-end. Missing call "
