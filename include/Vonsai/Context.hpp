...
enum class EMesh   : unsigned char { MONKEY, CUBE, PLANE, BODY, DRAGON, LAST };
...
private:
  ...
  std::vector<Renderable *> m_meshes;  // Must be pointers because Renderable doesn't have default-ctor.
